...
//#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  30, 110 }, { 180,  110 }, { 110, 30 } }
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  35, 35 }, { 180,  35 }, { 180, 180 }, { 35, 180 } }
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z 11
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 1        // (mm) Compression length applying to all extruders
  #endif
 ...
 */
  ...
  #define PROBE_PT_2_X 70
  #define PROBE_PT_2_Y 10
  #define PROBE_PT_3_X 230
